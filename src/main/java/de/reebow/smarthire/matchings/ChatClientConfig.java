...
class ChatClientConfig {
  ...
  private final static String SYSTEM_PROMPT = """
      ...
      **Output:**
      ...
      [
        {
          "jobId": <integer>, // The JobId of the matching offer, don't invent new job IDs.
          "matchDescription": "<string>", // Explanation of why the CV fits the job offer, citing specific skills and experiences. Be concise.
          "relevanceScore": <float between 0 and 1>, // Optional relevance score.  1 is a perfect match. Ignore everything below 0.5.
        },
        {
          "jobId": <integer>,
